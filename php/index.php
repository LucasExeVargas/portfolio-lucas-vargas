              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                  <a href="#sobremi" class="select-nav text-decoration-none">
                    <p class="text-nav text-nav-dark fs-3 fw-medium m-0">
                      Sobre mí
                    </p>
                  </a>
                </li>
                <li class="nav-item">
                  <a
                    href="#proyectos"
                    class="nav-link select-nav text-decoration-none"
                  >
                    <p class="text-nav text-nav-dark fs-3 fw-medium m-0">
                      Proyectos
                    </p>
  ...
  <script>
      document
        ...
        .addEventListener("click", function () {
          const navbarCollapse = document.querySelector("#navbarTogglerMobile");
